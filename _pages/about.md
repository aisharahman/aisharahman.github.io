...
- My major research field of interest is, and not limited to wireless communication networks, with interests in resource allocation and optimization in heterogeneous wireless networks using game theory, cognitive radio networks, network economics, Internet of Things, Simultaneous Wireless Information and Power Transmission (SWIPT). 
